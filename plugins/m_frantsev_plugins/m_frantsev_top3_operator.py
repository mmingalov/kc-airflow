"""
Загружаем в базу данных три локации c наибольшим количеством резидентов
"""
...
class FrantsevTopFromRickAndMorty(BaseOperator):

    def __init__(self, table_name: str = 'm_frantsev_ram_location', **kwargs):
