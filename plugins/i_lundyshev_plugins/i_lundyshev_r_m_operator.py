...
class LundyshevRamLocationOperator(BaseOperator):
    """
    Подсчет топа локаций по персонажам, списано с варинта с пандас :-) так как я его понимаю
    """
    ui_color = "#e0ffff"
    ...
    def get_page_count(self, api_url: str) -> int:
        """
        Считаем количество страниц - взято у Дины целиком
    ...
    def execute(self, context):
        ...
        logging.info(result_top_3_df)
        result_top_3_dict = result_top_3_df.to_dict()
        logging.info(result_top_3_dict)
