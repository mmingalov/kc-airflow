...
class ATroshin8RamLocationOperator(BaseOperator):
    """
    Find top-3 locations based on quatity of residents
    """

    ui_color = "#5cffad"

    def __init__(self, gp_table_name: str, gp_conn_id: str, **kwargs) -> None:
    ...
    def get_top3_on_page(self, result_json: list) -> int:
        ...
        Assumption: api return unique residents in list for every location.
        :param result_json:
