...
class ZhbanovaRamLocationOperator(BaseOperator):
    """
    Searching top-3 of locations
    """
    ui_color = "#eeffff"
        ...
        for page in range(self.get_page_count(api_url.format(pg='1'))):
            ...
            if r.status_code == 200:
                ...
                for i in range(len(page_result)):
                    result_df.loc[result_df_len + i] = [page_result[i]['id'],
                                                        page_result[i]['name'],
                                                        page_result[i]['type'],
                                                        page_result[i]['dimension'],
