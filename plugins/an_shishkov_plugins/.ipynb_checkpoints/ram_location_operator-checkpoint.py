...
class anshishkovRamLocationsTopThreeOperator(BaseOperator):
    '''
    Get top 3 RaMs locations by number of residents
    '''
    ...
    def execute(self, context):
        '''
        Getting top 3 RaMs locations by number of residents
        '''
        ram_loc_url = 'https://rickandmortyapi.com/api/location/?page={pg}'
        lctns_lst = list()
        for page in range(1, get_page_count(ram_loc_url.format(pg=page) + 1)):
