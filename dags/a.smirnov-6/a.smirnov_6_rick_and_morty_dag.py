...
dag_params = {
    'dag_id': 'asmirnov6_rickandmorty_dag',
    'catchup': False,
...
with DAG(**dag_params) as dag:
    ...
    create_gp_table = PostgresOperator(
        ...
        sql="""
            CREATE TABLE IF NOT EXISTS asmirnov6_ram_location
            (
    ...
    load_gp = PostgresOperator(
        ...
        postgres_conn_id='conn_greenplum_write',
        sql=[
            "TRUNCATE TABLE asmirnov6_ram_location",
            "INSERT INTO asmirnov6_ram_location VALUES {{ ti.xcom_pull(task_ids='ram_operator') }}",
        ],
        autocommit=True,
    )
